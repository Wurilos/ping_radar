// ==============================================
// PingAlert Pro — Sidebar Component
// ==============================================
        ...
        <div style={{ borderTop: '1px solid var(--color-border)', padding: 16 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12, padding: '8px 4px' }}>
            <div style={{
              ...
              background: 'linear-gradient(135deg, var(--color-accent), var(--color-accent-alt))', display: 'flex',
              alignItems: 'center', justifyContent: 'center', fontSize: 14, fontWeight: 700, color: '#000',
